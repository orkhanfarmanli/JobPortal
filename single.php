									...
									<div class="col-md-6">
										...
										<div class="col-md-6">
											<ul>
												...
												<li>Ali</li>
												<li>1 ildən aşağı</li>
												<li>Aprel 01, 2016i</li> 
												<li>May 01, 2016</li>
												<li>Лала Сулейманова</li>
											</ul>
										</div>
									</div>
									<div class="col-md-6">
										...
										<div class="col-md-9">
											<ul>
												<li><a href="#">(050) 254-61-55</a></li>
												<li><a href="#">office@etopaz.az</a></li>
											</ul>
										</div>
									</div>
								</div>
									...
									<div class="col-md-12">
										<div class="col-md-6">
											<h4>İş barədə məlumat</h4>
												<p>
													- Kardioloji və Cərrahi qruplara üstünlük verilir. Həmçinin rayonlarda vakansiya var 
													<br>
													- Tibb müəssələrini ziyarət etmək, şirkətin dərmanlarını tanıtmaq 
													<br>
													- Tibb müəssisələrində prezentasiyalar etmək 
													<br>
													- İş rejimi: 6 günlük
													<br>
										...
										<div class="col-md-6">
											...
											<p>
												- Ali və ya natamam ali təhsilli olmalıdır 
												<br>
												- Komandada işləmə qabiliyyəti olmalıdır
												<br> 
												- Dürüst və məsuliyyətli olmalıdır 
												<br>
												- Fikrini aydın ifadə etməyi bacarmalıdır 
												<br>
												- Yüksək ünsiyyət qurma bacarıqli olmalıdır 
												<br>
												- Nümayəndəlikdə təcrübəsi olanlara üstünlük verilir
